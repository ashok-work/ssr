...
export class DaterangepickerComponent implements OnInit {
    ...
    clear() {
        ...
        Array.prototype.forEach.call(document.getElementsByClassName("available"), function(elem) {
            elem.classList.remove("in-range");
            elem.classList.remove("start-date");
            elem.classList.remove("end-date");
            elem.classList.remove("active");
        });
        Array.prototype.forEach.call(document.getElementsByClassName("today"), function(elem) {
